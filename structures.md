...
Because of their durability and less stretchy structure, woven fabrics are commonly used in upholstery, demin, and tailored garments like suits. They are also used in industrial applications to create composite materials or abrasion resistant pads or architectural materials \(e.g. wire meshes, etc\).  
...
Wovens are described by the materials, equipment \(e.g. needle size\) and stitches used expressed in the form of [weaving patterns](documenting.md#wovens). 
